 ...
 */
final class Version20191130135302 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE responder_id responder_id INT NOT NULL, CHANGE question_id question_id INT NOT NULL');
